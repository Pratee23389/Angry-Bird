...
public class Level1 implements Screen {
    ...
    private pigs pig1;
    private structure struct1, struct2, struct3, struct4;
    private Sling sling;
    ...
    public void show() {
        ...
        image = new Texture("level1.jpg");  // load background image

        //level layout
        bird1 = new RedBird(95,65);
        bird2 = new BlueBird(75,65);
        bird3 = new BlackBird(45,65);
        bird4 = new WhiteBird(15,65);
        sling = new Sling(80,65);
        struct1 = new WoodRectangle(Gdx.graphics.getWidth()-100,65,10,70);
        struct2 = new WoodRectangle(Gdx.graphics.getWidth()-40,65,10,70);
        struct3 = new WoodRectangle(Gdx.graphics.getWidth()-100,135,70,10);
        struct4 = new StoneRectangle(Gdx.graphics.getWidth() - 90, 65,10,70);
        pig1 = new NormalPig(Gdx.graphics.getWidth() - 80,65);
